                ...
                <div className="absolute inset-0 flex flex-col justify-end p-16 bg-gradient-to-t from-dark/80 to-transparent">
                    ...
                    >
                        <h2 className="text-4xl font-serif font-bold text-white mb-4">
                            Join the Furnit Family
                        </h2>
                        <p className="text-white/80 text-lg max-w-md leading-relaxed">
                            Create your account and unlock exclusive access to premium furniture collections, personalized recommendations, and special offers.
                        </p>
                        <div className="mt-8 space-y-4">
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center text-white">✓</div>
                                <span className="text-white/90">Free shipping on orders over $1000</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center text-white">✓</div>
                                <span className="text-white/90">30-day easy returns</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center text-white">✓</div>
            ...
            <div className="w-full lg:w-1/2 flex flex-col lg:items-center lg:justify-center px-6 pt-32 lg:pt-12 pb-12 bg-background relative min-h-screen lg:min-h-0 overflow-y-auto lg:overflow-visible transition-colors duration-500">
                ...
                >
                    <div className="text-center mb-10">
                        <h2 className="text-4xl font-serif font-bold text-dark mb-3">Create Account</h2>
                        <p className="text-dark/60">Join the Furnit community today.</p>
                    </div>
                    ...
                    <div className="relative mb-8">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-background px-4 text-dark/40 font-bold tracking-widest transition-colors duration-500">Or sign up with email</span>
                        </div>
                    </div>

                    <form className="space-y-6" onSubmit={handleSubmit}>
                        <div>
                            <label className="block text-[10px] uppercase tracking-[0.2em] font-bold text-dark/60 mb-2 px-1">Full Name</label>
                            <div className="relative">
                                <UserIcon size={18} className="absolute left-5 top-1/2 -translate-y-1/2 text-dark/40" />
                                <input
                                    type="text"
                        ...
                        <div className="flex items-start gap-3 px-1">
                            <input type="checkbox" required className="w-4 h-4 mt-0.5 rounded border-soft text-accent focus:ring-accent" />
                            <label className="text-xs text-dark/60 leading-relaxed">
                                I agree to the <a href="#" className="text-accent font-bold hover:text-dark">Terms & Conditions</a> and <a href="#" className="text-accent font-bold hover:text-dark">Privacy Policy</a>
                            </label>
                        </div>
                    ...
                    <div className="mt-10 text-center">
                        <p className="text-sm text-dark/60">
                            Already have an account? <Link to="/login" className="text-dark font-bold hover:text-accent transition-colors underline underline-offset-4">Sign in</Link>
                        </p>
                    </div>
                </motion.div>
            </div>
